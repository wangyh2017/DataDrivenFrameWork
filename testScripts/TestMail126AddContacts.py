...
from chapt_15.DataDrivenFrameWork.util.Log import *
import  time
    ...
    try:
        ...
        for idx,i in enumerate(isExecuteUser[1:]):
            ...
            if i.value == 'y': #表示要执行
                ...
                logging.info(u"为用户 %s 添加%d个联系人，%d个成功\n"  %(username,isExecuteNum,contactsNum))
            else:
        ...
        logging.debug(u"数据驱动框架主程序发生异常，异常信息: %s" %str(traceback.print_exc()))
