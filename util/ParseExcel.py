...
class ParseExcel(object):
    ...
    def getColumn2(self, sheet, colNo):
...
if __name__ == '__main__':
    ...
    pe.loadWorkBook(u'/Users/wangyanhua/Documents/学习/Python/sele_frame/chapt_15/testData/126邮箱联系人3.xlsx')
    ...
    cols2 = pe.getColumn2(sheet,1)
    for  l in cols2:
        print u"读取getColumn1函数第1列内容", l.value
